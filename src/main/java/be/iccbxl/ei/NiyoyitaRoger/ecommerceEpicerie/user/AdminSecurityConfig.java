...
public class AdminSecurityConfig {
    ...
    public SecurityFilterChain filterChain1(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf()
                ...
                .requestMatchers("/","/signup","/display/**", "/produit","/produit/**","/user/signup","/produit/nouveau").permitAll() //changer nouveau produit
                .requestMatchers("/info-contact","/info-livraison","/info-retour","/info-utilisation","/info-confidentialite").permitAll()
